...
public class T06_SetTest {
   public static void main(String[] args) {
      ...
      // TreeSet은 데이터를 등록시 자동 정렬 기능이 들어가 있다.
      ...
      // tailSet(기준값, 논리값) : 논리값이 true 면 '기준값' 포함

      SortedSet<String> ss2 = ts.tailSet("K");
      System.out.println("K 이후 자료 : " + ss2);
      System.out.println("K 이후 자료(기준값 미포함) : " + ts.tailSet("K", false));

      // subSet(기준값1, 기준값2) => 기준값1 ~ 기준값2 사이의 값 가져옴. ('기준값1' 포함, '기준값2' 미포함)
      // subSet(기준값1, 논리값1, 기준값2, 논리값2) => 각 논리값을 이용하여 포함할지 여부를 설정한다.
      
      System.out.println("K(포함) 부터 N(미포함)까지 : " + ts.subSet("K", "N"));
      System.out.println("K(포함) 부터 N(포함)까지 : " + ts.subSet("K", true, "N", false));
